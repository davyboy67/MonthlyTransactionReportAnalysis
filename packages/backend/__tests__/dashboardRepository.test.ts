...
describe('DashboardRepository', () => {
  ...
  describe('getDashboardDetails', () => {
    ...
    it('should return ReportNotFoundError when no report is found by date', async () => {
      ...
      await expect(repository.getDashboardDetails(new Date('2024-01-01'))).rejects.toThrow(
        ReportNotFoundError
      );
    });
    ...
    it('should throw ReportNotFoundError when no report is found by id', async () => {
      ...
      await expect(repository.getDashboardDetails(new Date('2024-01-01'), 1)).rejects.toThrow(
        ReportNotFoundError
      );
    });
  });
